...
// processor. This demonstration shows how to write and read the MPU 9250
// registers by accessing them through the built-in I2C kernel driver. The I2C
// adapter is selected from userspace through the /dev interface. The i2c-dev
// module is needed but it's loaded by default.
//
