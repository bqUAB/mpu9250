...
void Mpu9250::ReadAccelData(int16_t* destination){
  ...
  ptr_i2c->ReadFromMemInto(kMpu6500Addr, kAccelXoutH, 6, &rawData[0]);
...
void Mpu9250::ReadGyroData(int16_t* destination){
  ...
  ptr_i2c->ReadFromMemInto(kMpu6500Addr, kGyroXoutH, 6, &rawData[0]);
  /* Turn the MSB and LSB into a signed 16-bit value */
  destination[0] = ((int16_t)rawData[0] << 8) | rawData[1];
  destination[1] = ((int16_t)rawData[2] << 8) | rawData[3];
  destination[2] = ((int16_t)rawData[4] << 8) | rawData[5];
...
void Mpu9250::ReadMagnetomData(int16_t* destination){
  ...
  if(ptr_i2c->ReadFromMem(kAk8963Addr, kSt1) & 0x01)
  {
    ...
    ptr_i2c->ReadFromMemInto(kAk8963Addr, kHxl, 7, &rawData[0]);
...
int16_t Mpu9250::ReadTempData() {
  ...
  ptr_i2c->ReadFromMemInto(kMpu6500Addr, kTempOutH, 2, &rawData[0]);
